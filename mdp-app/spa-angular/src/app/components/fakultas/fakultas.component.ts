...
import { NgxPaginationModule } from 'ngx-pagination'; // Impor modul ngx-pagination
 ...
 // Mengimpor CommonModule untuk memungkinkan penggunaan direktif Angular standar seperti *ngIf dan *ngFor di template
...
@Component({
  ...
  imports: [CommonModule, ReactiveFormsModule, NgxPaginationModul],  // Mengimpor CommonModule untuk memungkinkan penggunaan direktif Angular standar seperti *ngIf dan *ngFor di template
...
export class FakultasComponent implements OnInit {  // Deklarasi komponen dengan mengimplementasikan lifecycle hook OnInit
  ...
  currentPage = 1;
  itemsPerPage = 5;
  apiUrl = 'http://localhost:3000/api/fakultas';  // URL API yang digunakan untuk mendapatkan data fakultas
